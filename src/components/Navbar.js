      ...
      >
        <nav className="container-x flex items-center justify-between py-3" aria-label="Primary">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="inline-flex h-11 w-11 items-center justify-center rounded-full text-ink-800 ring-1 ring-ink-200 xl:hidden"
      ...
      <AnimatePresence>
        {open && (
          <>
            ...
            />
            <motion.div
              className="fixed right-0 top-0 z-50 flex h-full w-[85%] max-w-sm flex-col bg-white p-6 shadow-lift xl:hidden"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
